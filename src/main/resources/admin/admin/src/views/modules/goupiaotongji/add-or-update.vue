          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购票数量" prop="goupiaoshuliang">
          <el-input v-model="ruleForm.goupiaoshuliang" 
              placeholder="购票数量" clearable  :readonly="ro.goupiaoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购票数量" prop="goupiaoshuliang">
              <el-input v-model="ruleForm.goupiaoshuliang" 
                placeholder="购票数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购票金额" prop="goupiaojine">
          <el-input v-model="ruleForm.goupiaojine" 
              placeholder="购票金额" clearable  :readonly="ro.goupiaojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购票金额" prop="goupiaojine">
              <el-input v-model="ruleForm.goupiaojine" 
                placeholder="购票金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='goupiaoshuliang'){
            this.ruleForm.goupiaoshuliang = obj[o];
	    this.ro.goupiaoshuliang = true;
            continue;
          }
	            	            if(o=='goupiaojine'){
            this.ruleForm.goupiaojine = obj[o];
	    this.ro.goupiaojine = true;
            continue;
          }
	            	            if(o=='goupiaoriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `goupiaotongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.goupiaotongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
